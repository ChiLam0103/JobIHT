...
<body onload="window.print();">
    <div id="page" class="page">
        ...
        <div class="title-sub">TẦNG 3, TÒA NHÀ RIVERA PARK SÀI GÒN, SỐ 7/28 THÀNH THÁI, P.14, Q.10, TP.HCM <br> MST: 0303641267</div>
        ...
        <div class="tab-form">
            ...
            <nav class="padding-left-15">
                <ul>
                    ...
                    <nav class="padding-left-15">
                        <ul>
                            <li><p>a. Tờ khai:<i class="hr"></i></p></li>
                            <li><p>b. Packing list:</p></li>
                            <li><p>c.Invoice:</p></li>
                            <li><p>d: Hợp đồng</p></li>
                            <li><p>e: Định mức</p></li>
                            <li><p>f: Bill</p></li>
                            <li><p>g: Giấy phép</p></li>
                            <li><p>h: Chứng từ khác</p></li>
                        </ul>
                    </nav>
                </ul>
            </nav>
           ...
           <p>III. PHẦN KẾ TOÁN</p>
            <nav class="padding-left-15">
                <ul>
                   <li><p>1. Nhân viên tạm ứng: </p></li>
                   <li><p>2. Số tiền tạm ứng:</p></li>
                   <li><p>3. Số tiền còn lại:</p></li>
                </ul>
            </nav>
        </div> 
        <div class="footer">
