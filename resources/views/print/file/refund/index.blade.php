        ...
        <table class="table">
            ...
            @foreach ($data as $item)
                <tr class="text-align-left">
                    ...
                    <td>{{ $item->TAX_NOTE == 0 ? number_format($item->PRICE * $item->QTY,0,",",".") : number_format($item->TAX_AMT * $item->TAX_NOTE + $item->TAX_AMT * $item->QTY,0,",",".") }}
                    </td>
            ...
            <tr class="amount">
                ...
                <td colspan="2" style="text-align: left">{{ number_format($sum_money_after,0,",",".") }}</td>
            </tr>
        </table>
    </div>
</body>
