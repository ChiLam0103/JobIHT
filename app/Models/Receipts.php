        ...
        try {
            ...
            DB::table('RECEIPT')->insert(
                [
                    ...
                    'RECEIPT_TYPE' => ($request['RECEIPT_TYPE'] != 'undefined' || $request['RECEIPT_TYPE'] != 'null' || $request['RECEIPT_TYPE'] != null) ? $request['RECEIPT_TYPE'] : '1',
                    ...
                    'TOTAL_AMT' => ($request['TOTAL_AMT'] != 'undefined' || $request['TOTAL_AMT'] != 'null' || $request['TOTAL_AMT'] != null) ? $request['TOTAL_AMT'] : null,
                    ...
                    'TRANSFER_FEES' => ($request['TRANSFER_FEES'] != 'undefined' || $request['TRANSFER_FEES'] != 'null' || $request['TRANSFER_FEES'] != null) ? $request['TRANSFER_FEES'] : null,
