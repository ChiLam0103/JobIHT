                ...
                DB::table(config('constants.JOB_START_TABLE'))
                    ->insert(
                        [
                            ...
                            'ETA_ETD' => ($request['ETA_ETD'] != 'undefined' || $request['ETA_ETD'] != 'null' || $request['ETA_ETD'] != null) ? date("Ymd", strtotime($request['ETA_ETD'])) : null,
                            ...
                            'CUSTOMS_DATE' => ($request['CUSTOMS_DATE'] != 'undefined' || $request['CUSTOMS_DATE'] != 'null' || $request['CUSTOMS_DATE'] != null) ? date('Ymd', strtotime($request['CUSTOMS_DATE'])) : null,
